...
export type ExtractProps<T extends (new () => ComponentPublicInstance) | PropsDefinition> = T extends (new () => ComponentPublicInstance) ? ExtractPropsFromComponent<T> : T extends PropsDefinition ? ExtractPropsFromObject<T> : never;
export {};
